...
var Draggable = /** @class */ (function (_super) {
    ...
    Draggable.prototype.getProperTargetElement = function (evt) {
        ...
        var isPointer = evt.type.indexOf('pointer') !== -1 && _browser__WEBPACK_IMPORTED_MODULE_1__.Browser.info.name === 'safari' && parseInt(_browser__WEBPACK_IMPORTED_MODULE_1__.Browser.info.version) > 12;
...
/* harmony import */ var _syncfusion_ej2_inputs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @syncfusion/ej2-inputs */ "./node_modules/@syncfusion/ej2-inputs/src/form-validator/form-validator.js");
/* harmony import */ var _syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @syncfusion/ej2-base */ "./node_modules/@syncfusion/ej2-base/index.js");
/* harmony import */ var _syncfusion_ej2_notifications__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @syncfusion/ej2-notifications */ "./node_modules/@syncfusion/ej2-notifications/src/message/message.js");
//#region  Imports
...
//#endregion
//#region  LIcense
(0,_syncfusion_ej2_base__WEBPACK_IMPORTED_MODULE_1__.registerLicense)("Ngo9BigBOggjHTQxAR8/V1NGaF1cVWhIfEx1RHxQdld5ZFRHallYTnNWUj0eQnxTdEZjUX5ecHNVRWNVVUV1Xw==");
//#endregion
...
let customFn = (args) => {
    // console.log(formObject.getInputElement("Password").value);
    return (formObject.getInputElement("ConfirmPassword").value == passwordInput.value);
};
let options = {
    rules: {
        ...
        ConfirmPassword: {
            required: true,
            minLength: [customFn, "Password and Confirm password do not match!"],
        },
    },
};
let formObject = new _syncfusion_ej2_inputs__WEBPACK_IMPORTED_MODULE_2__.FormValidator("#registrationForm", options);
//#endregion
//#region NOTIFICATION SETUP
let notification = new _syncfusion_ej2_notifications__WEBPACK_IMPORTED_MODULE_3__.Message({
...
notification.element.style.top = "3.5%";
notification.element.style.right = "0";
notification.element.style.width = "40%";
notification.element.style.zIndex = "9999";
notification.element.style.display = "none";
notification.element.style.color = "White";
const notificationToggle = () => {
    if (notification.element.style.display == "none") {
        notification.element.style.display = "inline-flex";
        setTimeout(() => {
            notification.element.style.display = "none";
        }, 2000);
    }
...
const showNotification = (message, severity, showCloseIcon) => {
    notification.content = message;
    notification.severity = severity;
    notification.showCloseIcon = showCloseIcon;
    notificationToggle();
};
//#endregion
confirmPasswordInput.addEventListener("keypress", (e) => {
    formObject.validate("ConfirmPassword");
});
passwordInput.addEventListener("keypress", (e) => {
    formObject.validate("Password");
});
...
registrationForm.addEventListener("submit", (e) => {
    ...
    if (formObject.validate()) {
        jQuery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
            url: "https://localhost:44345/Account/Register",
            method: "POST",
            data: {
                Email: formObject.getInputElement("Email").value,
                Password: formObject.getInputElement("Password").value,
                ConfirmPassword: formObject.getInputElement("ConfirmPassword").value,
            },
            success: function (response) {
                if (response.success == true) {
                    ...
                    notification.element.style.color = "red";
